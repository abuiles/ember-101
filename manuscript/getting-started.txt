...
Before moving into the next chapter, let's make sure we are using the latest version of Ember and Ember-Data.

{title="", lang="bash"}
~~~~~~~~
bower install ember -F --save
bower install ember-data -F --save
~~~~~~~~
